...
class TestTestrailParser(unittest.TestCase):
	...
	def test_read_csv(self):
		...
		testrail_parser.read_csv('./docs/raw_data/mock_testrail_csv_1.csv')
		df = pd.read_csv('./docs/raw_data/mock_testrail_csv_1.csv')
		df = df[['ID', 'Title']]
	...
	def test_read_two_csv(self):
		testrail_parser = TestrailParser(['ID', 'Title'])
		testrail_parser.read_csv('./docs/raw_data/mock_testrail_csv_1.csv')
		testrail_parser.read_csv('./docs/raw_data/mock_testrail_csv_2.csv')
